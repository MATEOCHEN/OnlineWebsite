...
public class Addidas_Clothes2 extends Clothes {
	private String name;
	...
	public Addidas_Clothes2(String name, String pd_detail, String IDE, int price,ImageIcon icon,int quantity) {
	...
	public Addidas_Clothes2(ImageIcon url,String name,int price,int quantity) {
		this.icon = url;
		this.name = name;
		this.price = price;
		this.quantity = quantity;
